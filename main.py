...
def contact_us ():
    ...
    st.markdown("""
    <iframe src='https://webchat.botframework.com/embed/farmerbot-bot?s=C8KRN6CUcMU.qQsvHkz4NJRXiIfbzh0P4rU9VMKhmM3wLKWfJw9PffE'  style='min-width: 400px; width: 100%; min-height: 500px;'></iframe>
